...
public class GradingServiceTsts
{
   [Fact]
   ...
   [InlineData (101, 100, GradeLevel.Invalid)] //Boundary : score greater than max score
   [InlineData(50, 0, GradeLevel.Invalid)] //Boundary : max score is zero
    public void CalculateLetterGrade_VariousScores_ReturnsExpectedGrade(decimal score, decimal maxScore, GradeLevel expected)
    {
        //Arrange 
        var service = new GradingService();
